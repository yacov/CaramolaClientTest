...
//** use FINAL if the string WONT change anywhere in the project when it is used. indicator that the variable is a constant.
   ...
   public static final String POWERED_BY_XPATH = ".//*[contains(@class,'cbola-layer in-content-container-wrapper')]/div/div/div[2]/div[1]"; //"html/body/center/div/div/div[1]/div[2]/div[1]";
    ...
    // TRIVIA ENDING SCREEN NEW UI
    public static final String ENDING_SCREEN2_CHALLENGE_XPATH = ".//*[contains(@class,'cbola-layer in-content-container-wrapper')]/div/div[1]/div[1]/div[1]/div[3]/div[1]"; // Challenge
    public static final String ENDING_SCREEN2_YOUR_FRIENDS_XPATH = ".//*[contains(@class,'cbola-layer in-content-container-wrapper')]/div/div[1]/div[1]/div[1]/div[3]/div[2]"; // Your friends
    public static final String ENDING_SCREEN2_SHARE_FB_XPATH = ".//*[contains(@class,'cbola-layer in-content-container-wrapper')]/div/div[1]/div[1]/div[1]/div[3]/div[3]/div[1]/i";
    public static final String ENDING_SCREEN2_SHARE_TWITTER_XPATH = ".//*[contains(@class,'cbola-layer in-content-container-wrapper')]/div/div[1]/div[1]/div[1]/div[3]/div[3]/div[2]/i";
    public static final String ENDING_SCREEN2_NEXT_HEADER = ".//*[contains(@class,'cbola-layer in-content-container-wrapper')]/div/div[1]/div[1]/div[1]/div[3]/div[1]"; // Next quiz
    public static final String ENDING_SCREEN2_NEXT_TITLE = ".//*[contains(@class,'cbola-layer in-content-container-wrapper')]/div/div[1]/div[1]/div[1]/div[3]/div[2]"; // The title of next game
    public static final String ENDING_SCREEN2_START_BTN = ".//*[contains(@class,'cbola-layer in-content-container-wrapper')]/div/div[1]/div[1]/div[2]/div[1]/div[3]"; // START ANOTHER QUIZ
